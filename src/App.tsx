    ...
    <div className="min-h-screen text-gray-300">
      ...
      <section className="min-h-screen flex flex-col justify-center px-8 md:px-24 mx-auto relative">
        ...
        <div className="relative">
          ...
          <h1 className="text-5xl md:text-7xl font-bold text-gray-100 mb-4 bg-gradient-to-r from-gray-100 to-gray-400 bg-clip-text text-transparent">
            Harshit Raja
          </h1>
          <h2 className="text-4xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-[#674cff] to-[#9333ea] bg-clip-text text-transparent">
          ...
          <div className="flex gap-6">
            <a href="https://github.com/HarshitRaja1999" target="_blank" rel="noopener noreferrer" 
               className="text-[#674cff] hover:text-[#9333ea] transition-colors"
               aria-label="GitHub Profile">
              <Github className="w-6 h-6" aria-hidden="true" />
            </a>
            <a href="https://www.linkedin.com/in/harshit-raja-1411671b2/" target="_blank" rel="noopener noreferrer"
               className="text-[#674cff] hover:text-[#9333ea] transition-colors"
               aria-label="LinkedIn Profile">
              <Linkedin className="w-6 h-6" aria-hidden="true" />
            </a>
            <a href="mailto:iamharshitraja@gmail.com"
               className="text-[#674cff] hover:text-[#9333ea] transition-colors"
        ...
        <div className="flex items-center flex-col absolute bottom-10 left-1/2 transform -translate-x-1/2 animate-bounce">
          <div className="text-center">
            <a href="/MyPortfolio/assets/Harshit-Raja's-Resume.pdf" 
